                                    ...
                                    <div className="card-body py-1">
                                        ...
                                        <div className="chatbox-messages">
                                            <div className="message outgoing mb-1">
                                                <p className="bg-E79C1D text-white mb-0 px-2 py-2 info">
                                            ...
                                            <div className="message incoming mb-1 d-flex align-items-center align-self-start">
                                                ...
                                                <div className="message-name">
                                                    ...
                                                    <p className="bg-F3F0FF text-0D082C px-2 py-2 mb-0 info">
                                            ...
                                            <div className="message outgoing mb-1">
                                                <p className="bg-E79C1D text-white mb-0 px-2 py-2 info">
                                                    I have a question about the return policy for a
                                                    product I purchased.
                                                </p>
                                            </div>
                                            <div className="message incoming mb-1 d-flex align-items-center align-self-start">
                                                ...
                                                <div className="message-name">
                                                    <p className="mb-0 text-010A48 info">
                                                        454545454 - Rohit Sharma
                                                    </p>
                                                    <p className="bg-F3F0FF text-0D082C px-2 py-2 info mb-0">
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-4 col-12">
                            ...
                            >
                                ...
                                <div className="card-body">
                                    <p className="mb-0 my-2 text-010A48 fw-normal teach">
                                        {" "}
                                        <img src="Images/profile4.png" alt="" className="me-2" />
                                        454545454 - Ram Yadav
                                    </p>
                                    <p className="mb-0 my-2 text-010A48 fw-normal teach">
                                        <img src="Images/profile3.png" alt="" className="me-2" />
                                        454545454 - Rohit Sharma
                                    </p>
                                    <p className="mb-0 my-2 text-010A48 fw-normal teach">
                                    ...
                                    <p className="mb-0 my-2 text-010A48 fw-normal teach">
                                        <img src="Images/profile1.png" alt="" className="me-2" />
                                        446541115 - Sourabh Yadav
                                    </p>
                                </div>
                            </div>
                        </div>
