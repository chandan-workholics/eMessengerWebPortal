                ...
                <div className="container my-3">
                    <div className="row">
                        <div className="col-xl-8 col-lg-6 col-12">
                            <h4 className="text-DA251C">Display</h4>
                                    ...
                                    {detail?.data?.msg_body?.map((msgBody, index) => (
                                        <div key={index} className="col-12 col-lg-6 mb-4">
                                            <div className="">
                                                ...
                                                {msgBody?.data_text?.title && <h5 className="text-010A48 mb-0 fw-semibold">{msgBody.data_text.title}</h5>}
                        ...
                        <div className="col-xl-4 col-lg-6 col-12">
                            <h4 className="text-DA251C">Inputs</h4>
